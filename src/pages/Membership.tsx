...
const Membership = () => {
  const tiers = [
    ...
    },
    {
      ...
      price: "$29",
      period: "/شهرياً",
      description: "التجربة الكاملة للنخبة، وصول غير محدود لكل كنوز المنصة وشارات ملكية خاصة.",
      icon: Crown,
      ...
      features: [
        ...
        "شارات 'الصفوة' للملف الشخصي"
      ],
      cta: "انضم للنخبة الآن",
      highlight: true
    },
    {
      name: "بروتوكول الصفوة",
      price: "$99",
      period: "/سنوياً",
      description: "للمؤسسات وكبار الجامعين الداعمين لحفظ التراث العربي المعرفي بأعلى المعايير.",
      icon: Shield,
      iconBg: "bg-emerald-500/10",
      iconColor: "text-emerald-500",
      features: [
        "كل مزايا عضوية الصفوة",
        "دعم فني مخصص 24/7",
        "أدوات تحليل وبحث متقدمة",
        "إمكانية اقتراح كتب للرقمنة",
        "شهادة تقدير 'حامي التراث'",
